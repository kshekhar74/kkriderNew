...
class RiderLeadView extends ConsumerStatefulWidget {
  const RiderLeadView({super.key});

  @override
  ConsumerState<RiderLeadView> createState() => _RiderLeadViewState();
}

class _RiderLeadViewState extends ConsumerState<RiderLeadView> {
  ...
  void _showPopup() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text("By checking this box, you agree to our terms."),
        actions: [
          TextButton(
              ...
              child: Column(
                children: [
                  ...
                  _buildPasswordField(
                    ...
                    toggleVisibility: () => ref.read(passwordVisibilityProvider.notifier).state = !isPasswordVisible,
                  ),
                  _buildPasswordField(
                    ...
                    toggleVisibility: () => ref.read(confirmPasswordVisibilityProvider.notifier).state = !isConfirmPasswordVisible,
                  ),
                  Row(
                    children: [
                      Checkbox(
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          if (!isChecked) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text("Kindly select Terms and Conditions"),
                              ),
                            );
                            return;
                          }
                  ...
                  Row(
                    ...
                    children: [
                      Text("Already have an account? ", style: GoogleFonts.figtree(fontSize: 13)),
                      Text("Login", style: GoogleFonts.figtree(fontSize: 13, fontWeight: FontWeight.w600, color: Colors.green)),
                    ],
                  ),
                ],
              ),
